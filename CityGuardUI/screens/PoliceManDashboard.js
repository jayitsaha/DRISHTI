...
import NavOptionsPoliceMan from '../components/NavOptionsPoliceMan';
import ChartPolice from '../components/ChartPolice';

const { width: screenWidth, height: screenHeight } = Dimensions.get('window');

const colors = {
  // Police Theme Colors
  primary: '#3B228A', // Deep Blue Purple
  primaryLight: '#5B42AA',
  primaryDark: '#2B126A',
  ...
  // Gradients
  primaryGradient: ['#3B228A', '#5B42AA'],
  backgroundGradient: ['#F8FAFF', '#EEF2FF', '#E0E7FF'],
  glassGradient: ['rgba(255, 255, 255, 0.9)', 'rgba(255, 255, 255, 0.7)'],
};

const PoliceManDashboard = ({ navigation }) => {
  ...
  const loadUserData = async () => {
    try {
      ...
      if (cachedProfile) {
        ...
        if (parsedProfile.userType === USER_TYPES.POLICEMAN) {
      ...
      try {
        ...
        if (profile && profile.userType === USER_TYPES.POLICEMAN) {
          ...
          if (userDoc.exists()) {
            ...
            if (userData.userType === USER_TYPES.POLICEMAN) {
  ...
  const setupTaskListeners = (userIdParam) => {
    ...
    try {
      // Listen for unassigned safety issues
      ...
      // Listen for tasks assigned to this officer
  ...
  const handleTaskPress = (task) => {
    ...
    navigation.navigate('PoliceManViewTask', { task });
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            <View style={styles.headerLeft}>
              ...
              <Text style={styles.userName}>
                {userProfile?.rank || 'Officer'} {userProfile?.firstName || userProfile?.username || 'Officer'}
              </Text>
              <View style={styles.badgeContainer}>
                ...
                >
                  ...
                  <Text style={styles.badgeText}>
                    Badge #{userProfile?.badgeNumber || 'XXXX'}
                  </Text>
                </LinearGradient>
              </View>
            </View>
            ...
            >
              <View style={styles.heroContent}>
                <View style={styles.heroTextContainer}>
                  <Text style={styles.heroTitle}>Active Duty</Text>
                  <Text style={styles.heroSubtitle}>
                    {userProfile?.assignedBeat || 'Central District'}
                  </Text>
                  <TouchableOpacity 
                    style={styles.heroButton}
                    onPress={() => navigation.navigate('MapViewPoliceMan')}
                  >
          ...
          <View style={styles.statsGrid}>
            <StatCard
              value={userStats?.casesHandled || 0}
              label="Cases Handled"
          ...
          {assignedTasks.length > 0 && (
            <View style={styles.tasksSection}>
              <View style={styles.sectionHeader}>
                <Text style={styles.sectionTitle}>Your Active Cases</Text>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text style={styles.taskType} numberOfLines={2}>
                        {task.description || 'Safety issue reported'}
                      </Text>
          ...
          <View style={styles.tasksSection}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>New Safety Reports</Text>
              <TouchableOpacity onPress={() => navigation.navigate('AcceptRejectPoliceMan')}>
                <Text style={styles.viewAllText}>View all →</Text>
              </TouchableOpacity>
            </View>
            ...
            {pendingTasks.length > 0 ? (
              ...
              <View style={styles.noTasksContainer}>
                <BlurView intensity={90} tint="light" style={styles.noTasksCard}>
                  ...
                  />
                  <Text style={styles.noTasksTitle}>All Clear</Text>
                  <Text style={styles.noTasksText}>
                    No pending safety issues in your area
                  </Text>
                </BlurView>
              </View>
            )}
