...
const CleanerViewTask = ({ navigation, route }) => {
  ...
  const handleAcceptTask = async () => {
    ...
    try {
      ...
      await assignTaskToUser(user.uid, {
        taskId: taskData.id,
        cleaningTaskId: taskData.id, // Use cleaningTaskId for cleaners
        issueType: 'cleaning',
      ...
      showMessage({
        ...
        description: "You have been assigned to this cleaning task",
        type: "success",
        icon: "success",
        duration: 3000,
        style: {
  ...
  const handleStartCleaning = () => {
    navigation.navigate('CleanerUpload', { task: taskData });
  };

  const handleCompleteTask = () => {
    if (!beforeImage || !afterImage) {
      Alert.alert("Photos Required", "Please take before and after photos to complete the task.");
      return;
    }
  ...
  const submitCompletion = async () => {
    ...
    try {
      ...
      // Then update user's task history with cleaner-specific fields
      const userRef = doc(db, 'users', user.uid);
      await updateDoc(userRef, {
        activeTasks: arrayRemove(taskData.id),
      ...
      showMessage({
        ...
        description: "Cleaning task has been completed and closed",
        type: "success",
        icon: "success",
        duration: 3000,
      });
  ...
  const captureImage = async (camera) => {
    try {
      ...
      if (currentImageType === 'before') {
        setBeforeImage(photo.uri);
      } else {
        setAfterImage(photo.uri);
      }
  ...
  const getSeverityGradient = (severity) => {
    switch (severity) {
      case "Critical": return [colors.danger, colors.danger + "DD"];
      case "High": return [colors.warning, colors.warning + "DD"];
      case "Medium": return [colors.emerald, colors.green];
      default: return [colors.lime, colors.emerald];
    }
  };

  const getPriorityGradient = (score) => {
    if (score >= 8) return [colors.danger, colors.warning];
    if (score >= 5) return [colors.emerald, colors.lime];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <LinearGradient
          colors={[colors.pureWhite, colors.emerald, colors.pureWhite]}
      ...
      >
        ...
        >
              ...
              <View style={styles.mediaCard}>
                ...
                >
                  <View style={styles.mediaInfo}>
                    ...
                    <Text style={styles.mediaText}>Reported Evidence</Text>
                  </View>
                </LinearGradient>
              </View>
            </Animatable.View>
                ...
                >
                  ...
                  <View style={styles.audioTextContainer}>
                    ...
                    <Text style={styles.audioSubtitle}>
                      {isPlaying ? "Playing..." : "Tap to play citizen report"}
                    </Text>
                  </View>
              ...
              {isAnalyzing ? (
                <View style={styles.analyzingContainer}>
                  ...
                  >
                    ...
                    >
                      <MaterialCommunityIcons name="leaf" size={60} color={colors.pureWhite} />
                    </LinearGradient>
                  </Animatable.View>
                  
                  <Animatable.Text animation="fadeIn" style={styles.analyzingText}>
                    Analyzing Cleaning Task
                  </Animatable.Text>
                  <Text style={styles.analyzingSubtext}>
                    Processing task details and determining requirements
                  </Text>
                </View>
              ) : (
                <View style={styles.analysisCard}>
                  <View style={styles.analysisHeader}>
                    <MaterialCommunityIcons name="broom" size={24} color={colors.green} />
                    <Text style={styles.analysisTitle}>Task Analysis Complete</Text>
                  </View>
                  ...
                  <View style={styles.responseTimeContainer}>
                    <Feather name="clock" size={16} color={colors.emerald} />
                    <Text style={styles.responseTimeText}>
                      Response Required: {taskData?.responseTime || "Within 2 hours"}
                    </Text>
                  </View>
                  ...
                  <View style={styles.descriptionContainer}>
                    ...
                    <Text style={styles.descriptionText}>
                      {taskData?.description || "Cleaning task requiring attention"}
                    </Text>
                  </View>

                  {/* Cleaning Requirements */}
                  <View style={styles.actionsContainer}>
                    <Text style={styles.actionsLabel}>Cleaning Requirements</Text>
                    {(taskData?.cleaningRequirements || [
                      "Remove all waste materials",
                      "Clean and sanitize the area",
                      "Take before and after photos",
                      "Report any hazardous materials"
                    ]).map((action, index) => (
                      <Animatable.View
                        key={index}
                  ...
                  <View style={styles.detailsGrid}>
                    <View style={styles.detailCard}>
                      <MaterialCommunityIcons name="trash-can" size={20} color={colors.emerald} />
                      <Text style={styles.detailLabel}>Waste Type</Text>
                      <Text style={styles.detailValue}>
                        {taskData?.wasteType || "General"}
                      </Text>
                    </View>

                    <View style={styles.detailCard}>
                      <MaterialIcons name="square-foot" size={20} color={colors.emerald} />
                      <Text style={styles.detailLabel}>Area Size</Text>
                      <Text style={styles.detailValue}>
                        {taskData?.areaSize || "Medium"}
                      </Text>
                    </View>

                    <View style={styles.detailCard}>
                      <MaterialIcons name="location-on" size={20} color={colors.emerald} />
                      <Text style={styles.detailLabel}>Zone</Text>
                      <Text style={styles.detailValue}>
                        {taskData?.zone || "Zone A"}
                      </Text>
                    </View>

                    <View style={styles.detailCard}>
                      <MaterialIcons name="access-time" size={20} color={colors.emerald} />
                      <Text style={styles.detailLabel}>Est. Time</Text>
                      <Text style={styles.detailValue}>
                        {taskData?.estimatedTime || "30 min"}
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          {/* Photo Section - Only show if task is assigned */}
          {taskData?.status !== 'pending' && (
            <Animatable.View animation="fadeInUp" delay={450}>
              <View style={styles.photoSection}>
                <Text style={styles.photoSectionTitle}>Task Photos</Text>
          ...
          <Animatable.View animation="fadeInUp" delay={500}>
            <View style={styles.locationCard}>
              <View style={styles.locationHeader}>
                <MaterialIcons name="location-on" size={20} color={colors.green} />
              ...
              >
                ...
                >
                  ...
                  >
                    <MaterialCommunityIcons name="broom" size={24} color={colors.emerald} />
                  </Animated.View>
                </Marker>
              </MapView>
                    ...
                    <LinearGradient
                      colors={
                        beforeImage && afterImage
                          ? [colors.green, colors.forest]
                          : [colors.mediumGray, colors.darkGray]
                      }
            ...
            >
              <TouchableOpacity activeOpacity={1}>
                <View style={styles.modalCard}>
                  ...
                  >
                    <Text style={styles.modalTitle}>Task Completion</Text>
                    <Text style={styles.modalSubtitle}>
                      Provide details about the cleaning work performed
                    </Text>
                    
                    <View style={styles.modalInputContainer}>
                      <TextInput
                        style={styles.modalInput}
                        placeholder="Describe the work done and any issues found..."
                      ...
                      >
                        ...
                        >
                          {isSubmitting ? (
                            ...
                            <>
                              <MaterialIcons name="check" size={20} color="#FFF" />
                              <Text style={styles.modalSubmitText}>Complete Task</Text>
                            </>
                          )}
                        </LinearGradient>
                      </TouchableOpacity>
...
export default CleanerViewTask;