...
const PoliceManViewTask = ({ navigation, route }) => {
  ...
  const submitCompletion = async () => {
    ...
    try {
      ...
      // Then update user's task history
      const userRef = doc(db, 'users', user.uid);
      await updateDoc(userRef, {
        activeCases: arrayRemove(taskData.id),
        casesHandled: increment(1),
        caseHistory: arrayUnion({
          caseId: taskData.id,
          closedAt: new Date().toISOString(), // Use regular timestamp instead of serverTimestamp()
  ...
  const getSeverityGradient = (severity) => {
    switch (severity) {
      ...
      case "High": return [colors.safety, colors.safety + "DD"];
      case "Medium": return [colors.warning, colors.warning + "DD"];
      default: return [colors.gold, colors.gold + "DD"];
    }
  };

  const getPriorityGradient = (score) => {
    if (score >= 8) return [colors.danger, colors.safety];
    if (score >= 5) return [colors.champagne, colors.gold];
        ...
        >
          ...
          {taskData?.mediaUrls?.audioUrl && (
            <Animatable.View animation="fadeInUp" delay={300}>
              ...
              >
                <LinearGradient
                  colors={[colors.policeBlue, colors.policeBlueDark]}
                ...
                >
                  ...
                  <View style={styles.audioTextContainer}>
                    <Text style={styles.audioTitle}>Audio Evidence</Text>
                    <Text style={styles.audioSubtitle}>
                      {isPlaying ? "Playing..." : "Tap to play witness report"}
                    </Text>
                  </View>
            ...
            <View style={styles.analysisContainer}>
              {isAnalyzing ? (
                <View style={styles.analyzingContainer}>
                  ...
                  >
                    <LinearGradient
                      colors={[colors.policeBlue, colors.gold]}
                  ...
                  <Text style={styles.analyzingSubtext}>
                    Processing evidence and determining response priority
                  </Text>
                </View>
              ) : (
                <View style={styles.analysisCard}>
                  <View style={styles.analysisHeader}>
                    <MaterialCommunityIcons name="shield-alert" size={24} color={colors.policeBlue} />
                    <Text style={styles.analysisTitle}>Threat Analysis Complete</Text>
                  </View>
                  ...
                  <View style={styles.responseTimeContainer}>
                    ...
                    <Text style={styles.responseTimeText}>
                      Response Required: {taskData?.responseTime || "Within 1 hour"}
                    </Text>
                  </View>

                  {/* Threat Description */}
                  <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionLabel}>Threat Assessment</Text>
                    <Text style={styles.descriptionText}>
                      {taskData?.description || "Security threat requires immediate police response"}
                    </Text>
                  </View>
                  ...
                  <View style={styles.actionsContainer}>
                    ...
                    {taskData?.immediateActions?.map((action, index) => (
                      <Animatable.View
                        key={index}
                  ...
                  <View style={styles.detailsGrid}>
                    <View style={styles.detailCard}>
                      ...
                      <Text style={styles.detailValue}>
                        {taskData?.requiredPersonnel || "2-3 Officers"}
                      </Text>
                    </View>
                    ...
                    <View style={styles.detailCard}>
                      ...
                      <Text style={styles.detailValue}>
                        {taskData?.actualCategory || "Public Safety"}
                      </Text>
                    </View>
                    ...
                    <View style={styles.detailCard}>
                      <MaterialIcons name="warning" size={20} color={colors.gold} />
                      <Text style={styles.detailLabel}>Risk Level</Text>
                      <Text style={styles.detailValue}>
                        {taskData?.publicSafetyRisk || "Medium"}
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          <Animatable.View animation="fadeInUp" delay={500}>
            <View style={styles.locationCard}>
              <View style={styles.locationHeader}>
                <MaterialIcons name="location-on" size={20} color={colors.policeBlue} />
            ...
            >
              <TouchableOpacity activeOpacity={1}>
                <View style={styles.modalCard}>
                  ...
                  >
                    <Text style={styles.modalTitle}>Case Resolution</Text>
                    <Text style={styles.modalSubtitle}>
                      Provide details about how this case was resolved
                    </Text>
                      ...
                      >
                        ...
                        >
                          {isSubmitting ? (
                            ...
                            <>
                              <MaterialIcons name="check" size={20} color="#FFF" />
                              <Text style={styles.modalSubmitText}>Complete Case</Text>
                            </>
                          )}
                        </LinearGradient>
                      </TouchableOpacity>
...
export default PoliceManViewTask;